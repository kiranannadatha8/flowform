...
export const AI_PROMPT_VERSION = "2026-04-phase2-v1";
...
Schema: { "suggestions": [ { "kind": "text"|"textarea"|"email"|"number"|"select"|"boolean"|"date", "label": string, "required"?: boolean, "description"?: string, "placeholder"?: string, "options"?: [{"value": string, "label": string}], "reason": string } ] }
Rules:
...
Schema: { "suggestions": [ { "kind": "text"|"textarea"|"email"|"number"|"select"|"boolean"|"date", "label": string, "required"?: boolean, "description"?: string, "options"?: [{"value": string, "label": string}], "reason": string } ] }
Rules:
