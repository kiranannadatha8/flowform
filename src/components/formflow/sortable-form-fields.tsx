...
function SortableRow({
  ...
  return (
    <li
      ref={setNodeRef}
      style={style}
      className="flex flex-col gap-2 rounded-lg border border-zinc-200 bg-white p-3 text-sm shadow-sm dark:border-zinc-800 dark:bg-zinc-950 sm:flex-row sm:items-center"
    >
...
export function SortableFormFields({ fields, onReorder, onChangeField, onRemove }: Props) {
